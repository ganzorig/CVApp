...
class LoginActivity : AppCompatActivity() {
    ...
    fun createPerson() {
        //---------------------------------Contact---------------------------------//
        var contact1: Contact = Contact("99001122", "gbayarsaikhan@miu.edu.mn","g4nzorig","gzo_326","www.github.com/ganzorig","g4nzo")
        var contact3: Contact = Contact("99112323", "eganbaatar@miu.edu.mn","enkhee.hana10","enkhee21571517","www.github.com/egy10", "enkhuul88")
        var contact2: Contact = Contact("99090099", "oganbold@miu.edu.mn","oyunbold.ganbold","GanboldG","www.github.com/goyunbold","oyunboldg")
        var contact4: Contact = Contact("93090002", "notgonbayar@miu.edu.mn","norovdorjo","norovdoo","www.github.com/norovoo","norovdorjo")
        //---------------------------------Contact end---------------------------------//
        //---------------------------------Education---------------------------------//
